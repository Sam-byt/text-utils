    ...
    <nav className={`navbar navbar-${props.mode} navbar-expand-lg bg-${props.mode}`}>
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div className={`mx-2 form-check text-${props.mode === 'light' ? 'dark' :'light'}`}>
            <input className="form-check-input" type="color" style={{border:'none'}} id="colorPicker" onChange={props.changeTheme} value={props.myColor}/>
            <label className="form-check-label" htmlFor="colorPicker">theme</label>
          </div>
